...
void DAC1_Init(void)
{
    ...
    HAL_DAC_ConfigChannel(&DAC1_Handler,&DACCH1_Config,DAC_CHANNEL_2);//DAC通道1配置
...
{
	HAL_DAC_Stop(&DAC1_Handler,DAC_CHANNEL_2);  			//关闭DAC通道1
...
{
    HAL_DAC_SetValue(&DAC1_Handler,DAC_CHANNEL_2,DAC_ALIGN_12B_R,value);//12位右对齐数据格式设置DAC值
}
