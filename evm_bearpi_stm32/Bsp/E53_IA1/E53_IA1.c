...
/***************************************************************
* 函数名称: E53_IA1_LED_StatusSet
* 说    明: E53_IA1开发板上的LED灯的亮灭控制
* 参    数: status,LED灯的状态
* 返 回 值: 无
***************************************************************/
void E53_IA1_MOTOR_StatusSet(uint8_t status)
{
	HAL_GPIO_WritePin(IA1_Motor_GPIO_Port, IA1_Motor_Pin, status == 0 ? GPIO_PIN_RESET : GPIO_PIN_SET );	
}
...
* 返 回 值: 无
***************************************************************/
void E53_IA1_LED_StatusSet(uint8_t status)
{
	HAL_GPIO_WritePin(IA1_Light_GPIO_Port, IA1_Light_Pin, status == 0 ? GPIO_PIN_RESET : GPIO_PIN_SET );	
}
...
* 返 回 值: 无
***************************************************************/
void E53_IA1_Read_Data(float *lux,float *temper,float *humidity)
{
    ...
    *lux=Convert_BH1750();													//Read bh1750 sensor data 
    ...
    if( !tmp ) /* value is ture */
    {
        ...
        *temper = SHT3x_CalcTemperatureC( dat );    
    }
