...
* 返 回 值: 无
***************************************************************/
void E53_ST1_Read_Data(float *longitude,float *latitude)
{	
...
* 返 回 值: 无
***************************************************************/
void E53_ST1_LED_StatusSet(uint8_t status)
{
	HAL_GPIO_WritePin(ST1_LED_GPIO_Port, ST1_LED_Pin, status == 0 ? GPIO_PIN_RESET : GPIO_PIN_SET );	
}
...
* 返 回 值: 无
***************************************************************/
void E53_ST1_Beep_StatusSet(uint8_t status)
{
	if(status == 0)
